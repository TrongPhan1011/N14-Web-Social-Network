...
export const inCludesString = (string1, string2) => {
    if (string2.includes(string1)) return true;
    else {
        const convertText1 = removeVietnameseTones(string1).toLowerCase();
        const convertText2 = removeVietnameseTones(string2).toLowerCase();
        if (convertText2.includes(convertText1)) {
            return true;
        }
    }
    return false;
